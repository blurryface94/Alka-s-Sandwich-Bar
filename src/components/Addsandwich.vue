<template>
<div class ="add-sandwich container">
    <h2 class = "center-align red-text"> Make a Sandwich </h2>
   <form @submit.prevent="addsandwich">
   ...
   <div class="field add-ingredient">
       ...
       <div class = "field center-align">
           ...
           <button class="btn red"> Make a Sandwich </button>
       </div>
   </form>
   </div>
</template>
